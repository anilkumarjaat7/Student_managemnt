...
export async function POST(request: Request) {
  try {
    ...
    const {
      studentName, phone, courseId, teacherId, batchId, timing, days,
      mode, startDate, endDate, feesStatus, status, placement, note, remarks,
    } = body
...
export async function PUT(request: Request) {
  try {
    const body = await request.json()
    const {
      id, studentName, phone, courseId, teacherId, batchId, timing, days,
      mode, startDate, endDate, feesStatus, status, placement, note, remarks,
    } = body
